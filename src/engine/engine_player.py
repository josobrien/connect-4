...
class EnginePlayer(Player):
    ...
    def __init__(self, player_id, depth=5, num_in_row_to_win=4, num_rows=6, num_cols=7):
    ...
    def evaluate_possible_positions(self, current_game, is_maximising_player, depth, alpha, beta):
        ...
        # TODO arrange in order of what is likely to be best
        for possible_move in range(self.num_cols):
